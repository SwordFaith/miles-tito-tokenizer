...
#   Original path: python/sglang/srt/entrypoints/openai/encoding_dsv32.py
...
#   - Added ``is_deepseek_v32()`` and supporting helpers (copied from the
...
def render_messages(
    ...
    **kwargs: Any,
    ...
    """Render *messages* into a DeepSeek V3.2 prompt string.
