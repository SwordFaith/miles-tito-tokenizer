"""Tests for the DeepSeek V3.2 chat-template bridge.

Derived from miles/tests/fast/utils/chat_template_utils/test_deepseek_v32.py.
"""
...
from miles_tito_tokenizers import apply_chat_template
from miles_tito_tokenizers.encoders import deepseek_v32
...
def _reference_encode(messages, *, thinking: bool = False, drop_thinking: bool = True, **extra) -> str:
    """The canonical V3.2 rendering: a direct ``encode_messages`` call."""
    return deepseek_v32.encode_messages(
        messages,
