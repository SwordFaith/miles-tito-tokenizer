"""Template-level append-only verification.

Derived from miles/tests/fast/utils/chat_template_utils/test_pretokenized_chat.py.
"""
...
from miles_tito_tokenizers.template_jinja import load_hf_chat_template
...
def test_pretokenized(chat_template: str, case: CaseSpec, kwargs: dict):
    assert_pretokenized_equals_standard(
        ...
        pretokenized_num_message=case.pretokenized_num_message,
        tools=case.tools,
        **kwargs,
    )
