"""Tests for TokenSeqComparator.

Derived from miles/tests/fast/utils/chat_template_utils/test_token_seq_comparator.py.
"""
...
from miles_tito_tokenizers import MismatchType, TokenSeqComparator
from miles_tito_tokenizers.comparator import Segment
