"""Tests for the DeepSeek V4 chat-template bridge.

Derived from miles/tests/fast/utils/chat_template_utils/test_deepseek_v4.py.
"""
...
from miles_tito_tokenizers.encoders import deepseek_v4
...
def _reference_encode(messages, *, thinking: bool = False, drop_thinking: bool = True, **extra) -> str:
    """The canonical V4 rendering: a direct ``encode_messages`` call."""
    return deepseek_v4.encode_messages(
        messages,
